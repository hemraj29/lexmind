  ...
  <div class="bg-gray-800 border border-gray-700 rounded-xl p-4 max-w-lg">
    <div class="flex items-center gap-3 mb-3">
      ...
      <div>
        ...
        <p class="text-xs" :class="data.status === 'completed' ? 'text-green-400' : 'text-yellow-400'">
    ...
    <!-- Preview snippet -->
    <div v-if="data.markdown" class="bg-gray-900 rounded-lg p-3 mb-3 max-h-32 overflow-hidden">
      <p class="text-xs text-gray-400 leading-relaxed">{{ data.markdown }}</p>
    </div>
    ...
    <button
      ...
      @click="download"
      class="w-full px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition flex items-center justify-center gap-2"
    >
